...
- **[Kenney Input Prompts](https://kenney.nl/assets/input-prompts)** by Kenney — the controller button art shown on skill slots when you give a key a controller glyph. ([CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/))
